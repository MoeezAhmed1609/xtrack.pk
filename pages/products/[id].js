              ...
              <div className="col-lg-6 col-12 d-flex flex-column pt-4 ps-lg-2 ps-5">
                ...
                <span className="fs-3 text-danger">
                  {product.variant_groups[0]?.options[0]?.id == size
                    ? product.variant_groups[0].options[0].price
                        .formatted_with_code
                    : product.variant_groups[0]?.options[1]?.id == size
                    ? product.variant_groups[0].options[1].price
                        .formatted_with_code
                    ...
                    {product.inventory?.available > 0 ? (
                      product.variant_groups.length > 1 ? (
                        ...
                        <button
                          ...
                          style={{ width: '80%' }}
                          onClick={() =>
                            context.addToCart(product.id, quantity)
                          }
                        >
                          Add to cart
                        </button>
              ...
              >
                ...
                >
                  {productusage.length !== 0 ? (
                    <span>{productusage[0].usage}</span>
                  ) : (
